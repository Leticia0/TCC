...
<body>
 ...
 <form class="ui form" method="post" action="usuario.php?acao=create">
 	 ...
 	 <center><h3 style="padding-top: 2%">Encontre Restaurantes Próximos</h3></center>
   ...
   <div class="ui icon input" style="margin-left: 83%">
    ...
    <div style="margin-left: 27%" class="two fields">
        <div class="field">
            <label>Estado</label>
...
<div style="padding-left: 2%" id="animais">
     ...
     <div class="ui link cards" id="cards" align="center">
        ...
        <div class="card" id="cardsJogos">
            <div class="image">
                <a href="<#"><img class="ui fluid image" style="height: 290px; height: 190px" src="../../assets/img/waffles.jpg"> </a>
                <p>Café da Manhã</p>
            </div> 
        </div>
       ...
       <div class="ui link cards" id="cards" align="center">
          ...
          <div class="card" id="cardsJogos">
            ...
            <div class="image">
                <a href="<#"><img class="ui fluid image" style="height: 290px; height: 190px" src="../../assets/img/fast-food.jpg"> </a>
                <p>Fast Food</p>
            </div>
